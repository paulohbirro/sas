            ...
            <div class="col-left">
                <div class="box">
                    <div class="box-content">
                        ...
                        <div class="colored-bar-row">
                            <div class="title" title="Média do atendimento realizado pelo Sebrae MG, a partir das mesmas soluções da regional">Sebrae MG</div>
                            <div class="line">&nbsp;
                                <div class="total"></div>
                    ...
                    var data = google.visualization.arrayToDataTable([
                        ['mes/ano', 'Regional', 'Sebrae', 'Meta'],
                            ...
                            ?>
                                ...
                                ['<?php echo $mesAno->format('m/y') ?>', <?php echo number_format($regiao->mediaPorMes($mesAno, 'nota_atendimento'), 1, '.', '') ?>, <?php echo number_format($mediaGeralUltimos12Meses[$mesAno->format('m/y')]['nota_atendimento'], 1, '.', '') ?>, 8],
