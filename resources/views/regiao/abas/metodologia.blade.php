                ...
                <div class="box">
                    <div class="box-content">
                        ...
                        <div class="colored-bar-row">
                            <div class="title" title="Média das metodologias da região">Região</div>
                            <div class="line">&nbsp;
                                <div class="total"></div>
                        ...
                        <div class="colored-bar-row">
                            <div class="title" title="Média das metodologias realizadas pelo Sebrae MG, a partir das mesmas soluções da região">Sebrae MG</div>
                            <div class="line">&nbsp;
                                <div class="total"></div>
                    ...
                    var data = google.visualization.arrayToDataTable([
                        ['mes/ano', 'Regional', 'Sebrae', 'Meta'],
                            ...
                            ?>
                                ...
                                ['<?php echo $mesAno->format('m/y') ?>', <?php echo number_format($regiao->mediaPorMes($mesAno, 'nota_metodologia'), 1, '.', '') ?>, <?php echo number_format($mediaGeralUltimos12Meses[$mesAno->format('m/y')]['nota_metodologia'], 1, '.', '') ?>, 8],
