                    ...
                    var data = google.visualization.arrayToDataTable([
                        ['mes/ano', 'Micro', 'Sebrae', 'Meta'],
                            ...
                            ?>
                                ...
                                ['<?php echo $mesAno->format('m/y') ?>', <?php echo number_format($microregiao->mediaPorMes($mesAno, 'nps'), 1, '.', '') ?>, <?php echo number_format($mediaGeralUltimos12Meses[$mesAno->format('m/y')]['nps'], 1, '.', '') ?>, 80],
